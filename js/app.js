...
function initializeApp() {
  ...
  // Only add footer event listeners if elements exist
  const footerTitles = document.querySelectorAll(".js-footer-title");
  if (footerTitles.length > 0) {
    footerTitles.forEach((icon) => {
...
// Global function for footer list toggle (needs to be outside for 'this' context)
